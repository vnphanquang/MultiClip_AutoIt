...
Global Const $STEP_ON_INSTRUCTION = "Cycle Mode allows you to cycle through the active clips." & @CRLF & @CRLF & "Press ""CTRL + INSERT"" to toggle between Copy & Paste mode" & @CRLF & @CRLF & "Press ""Insert"" to either copy or paste, depeding on the mode you're in." & @CRLF & @CRLF & "See Help (Taskbar) for more"
...
Func About(ByRef $baseCtrl)
	...
	Local $lVersion = GUICtrlCreateLabel("Version     1.1 (complete build: 2018.12.28)", 16, 96, 269, 23)
	GUICtrlSetFont(-1, 12, 400, 0, "Times New Roman")
	GUICtrlSetColor(-1, 0x000000)
	Local $lAuthor = GUICtrlCreateLabel("Author:     Quang Phan", 16, 128, 143, 23)
	GUICtrlSetFont(-1, 12, 400, 0, "Times New Roman")
	GUICtrlSetColor(-1, 0x000000)
	Local $lContact = GUICtrlCreateLabel("Contact:    contact.quangphan@gmail.com", 16, 160, 269, 23)
	GUICtrlSetFont(-1, 12, 400, 0, "Times New Roman")
	GUICtrlSetColor(-1, 0x000000)
	Local $lSource = GUICtrlCreateLabel("Source Code && Downloads: ", 16, 192, 193, 23)
	GUICtrlSetFont(-1, 12, 400, 0, "Times New Roman")
	GUICtrlSetColor(-1, 0x000000)
	Local $lLink = GUICtrlCreateLabel("https://github.com/vnphanquang/MultiClip_AutoIt", 40, 216, 346, 19)
	GUICtrlSetFont(-1, 10, 400, 6, "Times New Roman")
	GUICtrlSetColor(-1, 0x0000FF)
	GUICtrlSetCursor(-1, 0)
	Local $icon = GUICtrlCreateIcon("icon\icon.ico", -1, 51, 16, 72, 64)
